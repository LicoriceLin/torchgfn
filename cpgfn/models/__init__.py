...
1. `num_outputs`: int
2. `share_trunk_with`: self|None

TODO
register models & architectures

'''

from .cycencoder import CircularEncoder
from .mlp import OneHotBackbone
...
#             raise ValueError("Model ({}: {}) must extend torch.nn.Module".format(name, cls.__name__))
